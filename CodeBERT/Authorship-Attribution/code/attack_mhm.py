...
from attacker_crossdomain import CrossDomainAttacker, MHM_Attacker
...
def main():
    ...
    attacker = MHM_Attacker(args, model_sub, model_tgt, tokenizer, codebert_mlm, tokenizer_mlm)
    ...
    for index, (example_eval) in enumerate(eval_dataset):
        ...
        _res = attacker.mcmc(example, code, subs)
