...
def main():
    ...
    for index, example in enumerate(eval_dataset):
        ...
        print("clean code:\n", code_pair[2])
        code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, names_to_importance_score, nb_changed_var, nb_changed_pos, replaced_words = attacker.greedy_attack_baseline(example,  substitute, code_pair)
        attack_type = "Greedy"
